...
public final class FaceCreateTemplate extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.face_create_template);
    ...
    private void saveTemplate(byte[] template) {
        ...
        requestToSaveFile("MMIDTemplate.dat", path -> {
            try {
                saveDataToUri(FaceCreateTemplate.this, path, template);
