...
public class FingerCreateTemplate extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.finger_create_template);
        ...
        */
        ...
        mStartChecksButton.setOnClickListener(v -> createTemplate());
    ...
    private void createTemplate() {
        new Thread(() -> {
            try {
                ...
                showToast("Put finger in position and capture");
    ...
    private void saveTemplate(byte[] template) {
        ...
        requestToSaveFile("MMIDTemplate.dat", path -> {
            try {
                saveDataToUri(FingerCreateTemplate.this, path, template);
